...
Q_CONSTINIT static const qt_meta_stringdata_LastTickWorker_t qt_meta_stringdata_LastTickWorker = {
    {
        ...
        QT_MOC_LITERAL(15, 13),  // "agentsUpdated"
        QT_MOC_LITERAL(29, 0),  // ""
        QT_MOC_LITERAL(30, 8),  // "agentIds"
        QT_MOC_LITERAL(39, 15),  // "updateLastItems"
        QT_MOC_LITERAL(55, 10)   // "stopWorker"
    },
    "LastTickWorker",
    "agentsUpdated",
    "",
...
void LastTickWorker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (LastTickWorker::*)(const QStringList & );
            if (_t _q_method = &LastTickWorker::agentsUpdated; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
